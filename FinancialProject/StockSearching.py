...
class Ui_StockSearching(object):
    def setupUi(self, StockSearching,prewindow):
        StockSearching.setStyleSheet("background-color: rgb(205, 219, 231);")
        StockSearching.setObjectName("StockSearching")
        StockSearching.resize(743, 542)
        ...
        self.btnUpdate.setStyleSheet("border-radius: 10px;\n"
        ...
        self.btnDelete.setStyleSheet("border-radius: 10px;\n"
                                     "background-color: rgb(105, 147, 184);\n"
                                     "color: rgb(255, 255, 255)")
        ...
        self.txtCurrentPrice.setStyleSheet("background-color: rgb(255, 255, 255);\n"
                                           "border-radius: 10px;"
        ...
        self.txtDividend.setStyleSheet("background-color: rgb(255, 255, 255);\n"
                                           "border-radius: 10px;"
                                       "color: rgb(105, 147, 184);")
        ...
        self.btnLogout.setGeometry(QtCore.QRect(670, 520, 75, 23))
        ...
        self.btnSearch.setStyleSheet("border-radius: 10px;\n"
                                     "background-color: rgb(105, 147, 184);\n"
                                     "color: rgb(255, 255, 255);")
        ...
        self.lblSearch.setStyleSheet("background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, StockSearching):
        ...
        StockSearching.setWindowTitle(_translate("StockSearching", "โปรแกรมคำนวณเงินออมสะสมหุ้น"))
        ...
        self.btnLogout.setText(_translate("StockSearching", "ย้อนกลับ"))
    ...
    def delete(self):
        msg = self.MessageBox()
        resp = ctypes.windll.user32.MessageBoxW(0, "Are you sure?", "Alert!", 4)
        with pymongo.MongoClient(server) as conn:
